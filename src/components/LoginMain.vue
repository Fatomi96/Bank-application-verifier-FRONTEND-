<template>
  <main>
      <div class="main-left">
          <h1 class="main-head">Log in to your account</h1>
          ...
          <form>
            ...
            <div class="cta">
                <button @click.prevent="login" class="main-start-btn">LOG IN</button>
            </div>
          </form>
      </div>
      <div class="main-img">
...
export default {
    ...
    methods: {
        async login() {
            let res = await axios.post('https://bank-app-verifier-backend.herokuapp.com/api/login-user', {
                email: this.email,
